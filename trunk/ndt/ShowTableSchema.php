...
$result = mysql_query("SHOW COLUMNS FROM tourn_setting");
if (!$result) {
...
$query="SELECT * from tourn where id=1995";
...
echo "ID=".mysql_result($tourn,$i,"id")."state=".mysql_result($tourn,$i,"state")." ".mysql_result($tourn,$i,"country")."<br>";
