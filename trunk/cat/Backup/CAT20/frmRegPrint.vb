...
Public Class frmRegPrint
    ...
    Sub MakePrefCheckerSheets()
        ...
        st.WriteLine("{")
        st.WriteLine("font-family:" & Chr(34) & "Arial" & Chr(34) & ";")
        st.WriteLine("font-size:16;")
        st.WriteLine("font-weight:bold;")
        st.WriteLine("}")
        st.WriteLine("</style>")
        st.WriteLine("</HEAD>")
        Dim fdprefs As DataRow() : Dim nRows As Integer : Dim dr As DataRow
        For x = 0 To ds.Tables("Entry").Rows.Count - 1
            ...
            If fdprefs.Length > 0 Then
                'print top of page
                st.WriteLine("<Center><div class=" & Chr(34) & "Heading" & Chr(34) & ">Pref checker sheet for " & ds.Tables("Entry").Rows(x).Item("Fullname").trim & "</div></center><br>")
                st.WriteLine("<TABLE>")
                st.WriteLine("<THEAD>")
                st.WriteLine("<TR>")
