Public Class frmElims
    ...
    Private Sub butHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butHelp.Click
        ...
        strHelp &= "Clicking the 'Download web ballots' button will download all ballots for the active round; make sure you click on a debate in a column BEFORE clicking this button.  All entered ballots should download and all decisions should update, however, you may wish to click on the debates one at a time to make sure the decisions have been recorded appropriately." & Chr(10) & Chr(10)
    ...
    Private Sub butAdvanceWODebate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butAdvanceWODebate.Click
        ...
        For x = 0 To fdBallots.Length - 1
            ...
            For y = 0 To fdScores.Length - 1
                fdScores(y).Item("Score") = 0
                If fdScores(y).Item("Recipient") = fdTeams(AdvanceWho) Then fdScores(y).Item("Score") = 1
            Next y
        Next x
        Call UpdateDecision(panel)
        Call CurrentWinners()
