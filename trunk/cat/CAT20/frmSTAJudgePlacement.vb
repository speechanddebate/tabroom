...
Completion:
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        strInfo &= "Mutuality is the difference between the ratings 2 teams give the judge.  If a judge is a 45% for one team and a 35% for another, the mutuality is 10 (percentage points)." & Chr(10) & Chr(10)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        MsgBox("You MUST run the pref initialize sequence before this page can work correctly.  To get there, exit this page, go to the ENTRY MANAGEMENT section on the main menu, and click the button that says 'Enter or edit judge preference and conflict information.'  From there, click the buttont that says 'Initialize Prefs (not destructive).'  You only need to do this once at the beginning of the tournament.  When you have finished the initialization, you can return to this page and use it for judge placement.")
    End Sub
End Class
