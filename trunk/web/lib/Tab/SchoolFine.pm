...
Tab::SchoolFine->columns(All => qw/id school tourn amount reason levied_on levied_by timestamp region judge payment deleted deleted_by deleted_on/);
...
__PACKAGE__->_register_datetimes( qw/levied_on deleted_on timestamp/);
