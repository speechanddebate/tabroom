...
.find(".row:visible:odd").addClass("odd");});});};function fixVisual(){zebraRows();$('table').trigger('applyWidgets');$('table').trigger('update',[true]);resizeAll();var base_url=window.location.origin.split('.').slice(-2).join('.');if(base_url!=='tabroom.com'){pleaseStop();}}
