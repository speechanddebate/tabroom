...
return _;};}));function fixVisual(){$(".main").html('<h3 class="centeralign redtext">This site is not Tabroom. It is a phishing attempt</h3><h4 class="centeralign">Fortunately it was not a very good one, so Chris Palmer was able to mess with them a little and put this message up instead</h4><h4>Real Tabroom will always say "https://www.tabroom.com" in the address bar.</h4><h5 class="centeralign">Also, it would not have worked anyway, for reasons I will not get into here</h5><p>But seriously people, stop trying to make my life more stressful and stop doing things like this.  There are no fortunes to be made here, just a more tired Tabroom developer.</p>');console.log('no seriously stop');}
