...
.find(".row:visible:odd").addClass("odd");});});};function fixVisual(){$('table').trigger('applyWidgets');$('table').trigger('update',[true]);resizeAll();zebraRows();$("select:not(.plain)").trigger("chosen:updated");}
