...
delete options.data?.post_method;$.ajax({...options,error:fuction(data,status,metadata){const reply=data.responseJSON;if(reply?.message){if(reply.destroy){$("#"+reply.destroy).remove();$("."+reply.destroy).remove();}
