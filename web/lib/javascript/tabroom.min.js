...
changeFocus(input);}else if(input.value.length>=len&&!containsElement(filter,keyCode)&&input.value!=10){if(len==3){console.log("length is len");if(/\.$/.test(input.value)){var number=input.value;number=number.slice(0,2);number=number*1;number+=.5;input.value=number;}else if(/5$/.test(input.value)){input.value=input.value/10;}else{input.value=input.value.slice(0,2);}}
