...
function autoWin(input,e,aff,neg,affid,negid){if(!(document.getElementById('toggleKeybaordShortcuts')||{}).checked){return;}
...
return true;}
function autoPoints(input,len,e,side,ratio,nototal,step){if(!(document.getElementById('toggleKeybaordShortcuts')||{}).checked){return;}
...
if(input.form[i]==input)index=i;else i++;return index;}
return true;}
function autoSel(input,event){if(!(document.getElementById('toggleKeybaordShortcuts')||{}).checked){return;}
...
if(input.form[i]==input)index=i;else i++;return index;}}
function autoTab(input,len,e){if(!(document.getElementById('toggleKeybaordShortcuts')||{}).checked){return;}
