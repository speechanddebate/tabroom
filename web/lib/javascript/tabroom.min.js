...
timers[uniqueId]=setTimeout(callback,ms);};})();$(document).ready(function(){$('a.login-window').click(function(){var loginBox=$(this).attr('href');$(loginBox).slideDown(300);var popMargTop=($(loginBox).height()+24)/2;var popMargLeft=($(loginBox).width()+24)/2;$(loginBox).css({'margin-top':-popMargTop,'margin-left':-popMargLeft});$('body').append('<div id="mask"></div>');$('#mask').fadeIn(300);$('#username').focus();return false;});$('a.close, #mask').live('click',function(){$('#mask').fadeOut(300,function(){$('#mask').remove();});$('.login-popup').slideUp(300);return false;});$('.hide-menu').click(function(){$('.menu').slideUp(300);$('.content').addClass('nomenu');$('.hide-menu').addClass('hidden');$('.show-menu').removeClass('hidden');});$('.show-menu').click(function(){$('.menu').slideDown(300);$('.content').removeClass('nomenu');$('.show-menu').addClass('hidden');$('.hide-menu').removeClass('hidden');});$('input').each(function(){$(this).width($(this).parent().width()-20);});$('textarea').each(function(){$(this).width($(this).parent().width()-20);});});$(window).resize(function(){waitForFinalEvent(function(){$('input').each(function(){$(this).width($(this).parent().width()-20);});$('textarea').each(function(){$(this).width($(this).parent().width()-20);});$('.chosen-container').each(function(){$(this).width($(this).parent().width()-20);});},150,"ThisIsSupposedToBeUniqueTheySay");});
