...
return old.apply(this,arguments);};})($.fn.attrs);function postSwitch(checkObject,replyUrl,confirmMessage){if(confirmMessage){alertify.confirm("Please confirm",alertMessage,function(e){if(e){}else{return;}},function(no){return;});}
...
return;}}});console.log(attributes);return;}
