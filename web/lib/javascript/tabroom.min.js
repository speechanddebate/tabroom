...
if(data.refresh){window.location.reload();}}else if(data.message){alertify.set('notifier','delay',10);const response=alertify.warning(`${data.message}`,"custom");if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}
