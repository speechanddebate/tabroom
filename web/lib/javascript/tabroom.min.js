...
function copyToClipboard(elementId){var $temp=$("<input>");$("body").append($temp);const copied=$("#"+elementId).text().trim();$temp.val($("#"+elementId).text()).select();document.execCommand("copy");$temp.remove();alertify.notify(`Copied ${copied}to clipboard`,`custom`);}
