...
return old.apply(this,arguments);};})($.fn.attrs);function postSwitch(checkObject,replyUrl,callback,confirmMessage){if(confirmMessage!=undefined&&confirmMessage!=""){alertify.confirm("Please confirm",confirmMessage,function(e){if(e){}else{return;}},function(no){return;});}
...
if(data.error){alertify.error(data.message);console.log(data);if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}
...
if(data.refresh){window.location.reload();}}else if(data.message){alertify.dismissAll();alertify.notify(data.message,"custom");if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}
...
.find(".row:visible:odd").addClass("odd");});});};function fixVisual(){zebraRows();$('table').trigger('applyWidgets');$('table').trigger('update',[true]);resizeAll();}
...
timers[uniqueId]=setTimeout(callback,ms);};})();function resizeAll(){$('input[type=text]').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")||$(this).parent().is("label")){}else{$(this).width($(this).parent().width()-20);}});$('input[type=email]').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")||$(this).parent().is("label")){}else{$(this).width($(this).parent().width()-20);}});$('input[type=tel]').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")||$(this).parent().is("label")){}else{$(this).width($(this).parent().width()-20);}});$('input[type=url]').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")||$(this).parent().is("label")){}else{$(this).width($(this).parent().width()-20);}});$('textarea').each(function(){$(this).width($(this).parent().width()-20);});$('.chosen-container').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")){}else{$(this).width($(this).parent().width()-20);}});}
function toggleView(elementId,elementClass){$("."+elementClass).addClass('hidden');$("."+elementId).removeClass('hidden');fixVisual();}
