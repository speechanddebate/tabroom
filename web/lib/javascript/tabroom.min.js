...
if(data.error){alertify.error(data.message);if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}}else if(data.message){alertify.dismissAll();alertify.notify(data.message,"custom");if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}
...
if(data.setvalue){data.setvalue.forEach(function(item){if(item.content){$("#"+item.id).val(item.content);}});}
