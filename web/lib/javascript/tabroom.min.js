...
break;}}};});if(typeof module==='object'&&typeof module.exports==='object'){module.exports=alertify;}else if(typeof define==='function'&&define.amd){define([],function(){return alertify;});}else if(!window.alertify){window.alertify=alertify;}}(typeof window!=='undefined'?window:this));(function($){var $ie6=(function(){return false===$.support.boxModel&&$.support.objectAll&&$.support.leadingWhitespace;})();$.jGrowl=function(m,o){if($('#jGrowl').size()==0)
...
target[name]=props[name];return target;};$.timepicker=new Timepicker();$.timepicker.initialized=false;$.timepicker.uuid=new Date().getTime();$.timepicker.version="0.3.2";window['TP_jQuery_'+tpuuid]=$;})(jQuery);function confirmAction(link,message){alertify.confirm("Are you sure?",message,function(event){if(event){window.location.href=link.href;}},function(event){if(event){alertify.error("Canceled");}});return false;}
function postSwitch(checkObject,replyUrl){var targetId=$("#"+checkObject.id).attr("target_id");var propertyName=$("#"+checkObject.id).attr("property_name");var settingName=$("#"+checkObject.id).attr("setting_name");var propertyValue=checkObject.value;if(propertyValue===undefined){propertyValue=$("#"+checkObject.id).attr("value");}
if(checkObject.type==="checkbox"){if($("#"+checkObject.id).prop("checked")===false){propertyValue=0;}}
$.ajax({type:'POST',url:replyUrl,data:{target_id:targetId,property_name:propertyName,setting_name:settingName,property_value:propertyValue},success:function(data){$('table').trigger('applyWidgets');if(data.reply){$(".replybucket").text(data.reply);}
if(data.error){alertify.error(data.message);}else{alertify.notify(data.message,"custom");}}});}
function zebraRows(){$(".main").find(".row:even").addClass("even");$(".main").find(".row:odd").addClass("odd");$(".blankfull").find(".row:even").addClass("even");$(".blankfull").find(".row:odd").addClass("odd");$(".menu").find(".row:even").addClass("even");$(".menu").find(".row:odd").addClass("odd");$(".sidenote").find(".row:even").removeClass("odd");$(".sidenote").find(".row:odd").removeClass("even");$(".sidenote").find(".row:even").addClass("even");$(".sidenote").find(".row:odd").addClass("odd");$("table").find(".row:even").removeClass("odd");$("table").find(".row:even").addClass("even");$("table").find(".row:odd").removeClass("even");$("table").find(".row:odd").addClass("odd");$(".pagehalf").find(".row:even").addClass("even");$(".pagehalf").find(".row:even").removeClass("odd");$(".pagehalf").find(".row:odd").addClass("odd");$(".pagehalf").find(".row:odd").removeClass("even");$(".main").find(".lightrow:even").addClass("lighteven");$(".main").find(".lightrow:even").removeClass("lightodd");$(".main").find(".lightrow:odd").addClass("lightodd");$(".main").find(".lightrow:odd").removeClass("lighteven");$(".blankfull").find(".lightrow:even").addClass("lighteven");$(".blankfull").find(".lightrow:even").removeClass("lightodd");$(".blankfull").find(".lightrow:odd").addClass("lightodd");$(".blankfull").find(".lightrow:odd").removeClass("lighteven");$(".menu").find(".lightrow:even").addClass("lighteven");$(".menu").find(".lightrow:odd").addClass("lightodd");$(".sidenote").find(".lightrow:even").removeClass("lightodd");$(".sidenote").find(".lightrow:even").addClass("lighteven");$(".sidenote").find(".lightrow:odd").removeClass("lighteven");$(".sidenote").find(".lightrow:odd").addClass("lightodd");$("table").find(".lightrow:even").removeClass("lightodd");$("table").find(".lightrow:even").addClass("lighteven");$("table").find(".lightrow:odd").removeClass("lighteven");$("table").find(".lightrow:odd").addClass("lightodd");$(".pagehalf").find(".lightrow:even").addClass("lighteven");$(".pagehalf").find(".lightrow:even").removeClass("lightodd");$(".pagehalf").find(".lightrow:odd").addClass("lightodd");$(".pagehalf").find(".lightrow:odd").removeClass("lighteven");};function uploaderName(uploader,filedisplay){if(uploader==null){uploader='upload';}
