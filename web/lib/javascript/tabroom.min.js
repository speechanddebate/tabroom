...
if(data.replace){data.replace.forEach(function(item){if(item.destroy){$("#"+item.id).remove();}else if(item.content){$("#"+item.id).html(item.content);}});}}else{console.log(data);alertify.warning("An error condition was tripped.");}}});}
