...
if(data.error){alertify.error(data.message);}else if(data.message){alertify.dismissAll();alertify.notify(data.message,"custom");if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}
