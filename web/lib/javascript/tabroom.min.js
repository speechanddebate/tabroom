...
if(input.form[i]==input)index=i;else i++;return index;}
return true;}
function autoSel(input){var next_index=getIndex(input)+1;while(input.form[next_index].tabIndex==-1){next_index=next_index+1;if(next_index>input.form.length)break;}
