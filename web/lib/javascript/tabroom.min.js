...
if(data.error){$.jGrowl(data.message,{header:'Oops!',life:4000,position:'top-center',theme:"warning"});}else{$.jGrowl(data.message,{header:'Result',life:1000,position:'top-center'});}}});}
