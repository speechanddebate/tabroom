...
$.ajax({...options,error:function(data,status,metadata){console.log(data);const reply=data.responseJSON||data.responseText;alertify.set('notifier','delay',15);if(reply&&reply.message){if(reply.destroy){$("#"+reply.destroy).remove();$("."+reply.destroy).remove();}
