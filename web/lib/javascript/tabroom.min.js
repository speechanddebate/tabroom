...
timers[uniqueId]=setTimeout(callback,ms);};})();function resizeAll(){$('input[type=text], input[type=email], input[type=tel], input[type=date], input[type=time], input[type=url]').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")||$(this).parent().is("label")){}else{$(this).width($(this).parent().width()-10);}});$('textarea').each(function(){$(this).width($(this).parent().width()-10);});$('.chosen-container').each(function(){if($(this).parent().is("td")||$(this).parent().is("th")){}else{$(this).width($(this).parent().width()-10);}});}
