...
$.ajax({type:'POST',url:replyUrl,data:{target_id:targetId,property_name:propertyName,setting_name:settingName,property_value:propertyValue,other_value:otherValue,option_one:optionOne,option_two:optionTwo,other_text:otherText,related_thing:relatedThing,tourn_id:tournID,parent_id:parentObjectId},success:function(data){if(data.reply){if(replyTarget){$("#"+replyTarget).text(data.reply);}
