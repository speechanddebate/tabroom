...
return;}});}
function zebraRows(){var tags=['.row','.lightrow'];tags.forEach(function(tag){$(document).find(tag).parent().closest("span, div, table").find(".row:even").removeClass("odd");$(document).find(tag).parent().closest("span, div, table").find(".row:even").addClass("even");$(document).find(tag).parent().closest("span, div, table").find(".row:odd").removeClass("even");$(document).find(tag).parent().closest("span, div, table").find(".row:odd").addClass("odd");});};function uploadName(inputBox){var fileTag=$(inputBox).attr("id");var fileName=$("#"+fileTag).val().replace(/C:\\fakepath\\/i,'');$("."+fileTag).html(fileName);$("."+fileTag).html(fileName);}
