...
return old.apply(this,arguments);}})($.fn.attrs);function postSwitch(checkObject,url,callback,confirmMessage){console.log(`I am here`);if(confirmMessage&&confirmMessage!==''){alertify.confirm("Please confirm",confirmMessage,function(e){if(e){}else{return;}},function(no){return;});}
