...
$.ajax({type:accessType,url:replyUrl,data:attributes,success:function(data,status,object,newCallback){if(data){if(data.reply){if(attributes.reply_target){$("#"+attributes.reply_target).text(data.reply);}
