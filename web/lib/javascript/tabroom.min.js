...
if(data.error){alertify.error(data.message);console.log("Here I am.  Data refresh is"+data.refresh);console.log(data);if(data.destroy){$("#"+data.destroy).remove();$("."+data.destroy).remove();}
