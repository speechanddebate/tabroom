...
function confirmAll(master,targetClass){console.log("Confirming value for "+master.id);if($(master).prop("checked")===false){$("."+targetClass).prop("checked",false);}else{$("."+targetClass).prop("checked",true);}}
