...
return;}});}
function zebraRows(){$(document).find(".row").parent().find(".row:even").removeClass("odd");$(document).find(".row").parent().find(".row:even").addClass("even");$(document).find(".row").parent().find(".row:odd").removeClass("even");$(document).find(".row").parent().find(".row:odd").addClass("odd");$(document).find(".lightrow").parent().find(".row:even").addClass("even");$(document).find(".lightrow").parent().find(".row:even").removeClass("odd");$(document).find(".lightrow").parent().find(".row:odd").addClass("odd");$(document).find(".lightrow").parent().find(".row:odd").removeClass("even");};function uploadName(inputBox){var fileTag=$(inputBox).attr("id");var fileName=$("#"+fileTag).val().replace(/C:\\fakepath\\/i,'');$("."+fileTag).html(fileName);$("."+fileTag).html(fileName);}
