...
$.ajax({...options,error:function(data,status,metadata){console.log(`FAILBOAT SINKS LIKE ONLY IT CAN`);const reply=data.responseJSON||data.responseText;console.log(reply);alertify.set('notifier','delay',15);if(reply&&reply.message){if(reply.destroy){$("#"+reply.destroy).remove();$("."+reply.destroy).remove();}
