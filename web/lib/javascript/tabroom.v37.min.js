...
.find(".row:visible:odd").addClass("odd");});});};function scrollToBottom(element){element.scrollTo({top:element.scrollHeight,behavior:'smooth'});}
function fixVisual(){$('table').trigger('applyWidgets');$('table').trigger('update',[true]);resizeAll();zebraRows();$("select:not(.plain)").select2({minimumResultsForSearch:5,width:'104%',dropdownCssClass:'selection_text',});}
