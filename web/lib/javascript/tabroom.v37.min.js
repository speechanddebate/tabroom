...
.find(".row:visible:odd").addClass("odd");});});};function fixVisual(){$('table').trigger('applyWidgets');$('table').trigger('update',[true]);resizeAll();zebraRows();$("select:not(.plain)").select2({minimumResultsForSearch:5,width:'104%',dropdownCssClass:'selection_text',});}
