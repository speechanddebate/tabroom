...
$.ajax({type:options.method,data:attributes,crossDomain:true,xhrFields:{withCredentials:true},url}).then(function(data){if(data.reply){if(attributes.reply_target){$("#"+attributes.reply_target).text(data.reply);}
