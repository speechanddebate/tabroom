...
Tab::Entry->columns(Others => qw/seed bid title ada drop_time reg_time timestamp drop_by reg_by off_waitlist tba self_reg_by sweeps placement pair_seed cat_id/);
