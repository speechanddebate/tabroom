package Tab::NSDA::NationalsDBI;
use base 'Class::DBI';
use Class::DBI::AbstractSearch;

Tab::NSDA::NationalsDBI->connection("dbi:mysql:$Tab::nationals_dbname:$Tab::nationals_dbhost", 
	$Tab::nationals_dbuser,
	$Tab::nationals_dbpass
) || die $!;;
