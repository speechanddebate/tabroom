...
Public Class frmDataFileLoader
    ...
    Sub SchemaDownloader()
        ...
        Try
            Dim URL As String
            URL = "http://www.tabroom.com/jbruschke/DataFiles/TourneyData.xsd"
            Dim request As HttpWebRequest = WebRequest.Create(URL)
            Dim response As HttpWebResponse = request.GetResponse()
            Dim reader As StreamReader = New StreamReader(response.GetResponseStream())
    ...
    Sub PresetsDownloader()
        ...
        Try
            Dim URL As String
            URL = "http://www.tabroom.com/jbruschke/DataFiles/Presets.txt"
            Dim request As HttpWebRequest = WebRequest.Create(URL)
            Dim response As HttpWebResponse = request.GetResponse()
            Dim reader As StreamReader = New StreamReader(response.GetResponseStream())
    ...
    Private Sub butTestDownload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butTestDownload.Click
        ...
        Try
            Dim URL As String
            URL = "http://www.tabroom.com/jbruschke/DataFiles/TourneyData.xml"
            If chkMPJSample.Checked = True Then
                URL = "http://www.tabroom.com/jbruschke/DataFiles/TourneyDataCSUFWithFakeNames.xml"
            End If
            Dim request As HttpWebRequest = WebRequest.Create(URL)
            Dim response As HttpWebResponse = request.GetResponse()
            Dim reader As StreamReader = New StreamReader(response.GetResponseStream())
