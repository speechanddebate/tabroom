...
update result_set set tag='nsda', circuit=83, entity='entry' where label like "District Qualifiers%";
...
update result_set set tag='circuit', entity='entry' where label like "NDCA%";
update result_set set circuit = 274 where label like "NDCA%";

update result_set set tag='circuit', entity='entry' where label like "TOC%";
